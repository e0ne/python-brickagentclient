# -*- coding: utf-8 -*-
#
# python-brickclient documentation build configuration file, created by
...
# .
latex_documents = [
    ('index', 'python-brickclient.tex', 'python-brickclient Documentation',
